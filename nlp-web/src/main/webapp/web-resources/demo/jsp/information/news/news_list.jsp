...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="news/list.do?isM1=${pdm.isM1 }&isM2=${pdm.isM2 }" method="post" name="userForm" id="userForm">
			<table border='0'>
				<tr>
					...
					<td style="vertical-align:top;"> 
					 	<select class="chzn-select" name="recommand" data-placeholder="推荐否" style="vertical-align:top;width: 79px;">
						<option value=""></option>
